...
it('Forbid non-printable characters', function () {
  assert.throws(function () { load('\x01') }, YAMLException)
  assert.throws(function () { load('\x7f') }, YAMLException)
  assert.throws(function () { load('\x9f') }, YAMLException)
})

it('Forbid lone surrogates', function () {
  assert.throws(function () { load('\udc00\ud800') }, YAMLException)
})
...
it('Forbid control sequences inside quoted scalars', function () {
  assert.throws(function () { load('"\x03"') }, YAMLException)
})
